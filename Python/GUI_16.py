...
class ArduinoControl(tk.Tk):
    ...
    def __init__(self):
        ...
        # Place for Video Feed 0
        self.video_feed_place_0 = tk.Label(self)
        self.video_feed_place_0.grid(row=10, column=0, columnspan=6)
        self.cap0 = cv2.VideoCapture(0)

        # Place for Video Feed 1
        self.video_feed_place_1 = tk.Label(self)
        self.video_feed_place_1.grid(row=10, column=6, columnspan=6)
    ...
    # Define function to show video0
    def show_frames_0(self):
       # Get the latest frame and convert into Image
       self.cv2image = cv2.cvtColor(self.cap0.read()[1],cv2.COLOR_BGR2RGB)
       self.img = Image.fromarray(self.cv2image)
       # Convert image to PhotoImage
       self.imgtk = ImageTk.PhotoImage(image = self.img)
       self.video_feed_place_0.imgtk = self.imgtk
       self.video_feed_place_0.configure(image=self.imgtk)
       # Repeat after an interval to capture continiously
       self.video_feed_place_1.after(10, self.show_frames_0)
       

    # Define function to show video1
    def show_frames_1(self):
       # Get the latest frame and convert into Image
       self.cv2image = cv2.cvtColor(self.cap1.read()[1],cv2.COLOR_BGR2RGB)
       self.img = Image.fromarray(self.cv2image)
       # Convert image to PhotoImage
       self.imgtk = ImageTk.PhotoImage(image = self.img)
       self.video_feed_place_1.imgtk = self.imgtk
       self.video_feed_place_1.configure(image=self.imgtk)
       # Repeat after an interval to capture continiously
       self.video_feed_place_1.after(10, self.show_frames_1)
